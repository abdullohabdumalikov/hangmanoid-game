...
const localWords = {
  ...
  FootballPlayers: [
    "MESSI", "RONALDO", "NEYMAR", "MBAPPE", "HAALAND", "SALAH", "KROOS", "KANTE", "LEWANDOWSKI", "SERGIO", "MODRIC", "SANE", "FODEN", "GREALISH", "RASHFORD", "SANCHO", "KANE", "BENZEMA", "LUKAKU", "STERLING", "SON", "MULLER", "ALISSON", "SUAREZ", "EDERSON", "COURTOIS", "OBLAK", "ONANA", "ARNOLD", "GULACSI", "NAVAAS", "TRAPP", "LENO", "MARCHESIN", "KARNEZIS", "PICKFORD", "GUENDOUZI", "FABIANSKI", "LOPEZ", "MENDY", "ROBINSON", "TIERNEY", "SANCHEZ", "COUTINHO", "WERNER", "HAVERTZ", "KOVACIC", "RODRIGUEZ", "BALE", "RONALDINHO", "ROBBEN", "ZIDANE", "CANNAVARO", "PEREZ", "GERRARD", "SCHWEINSTEIGER", "INIESTA", "PIRLO", "GRIEZMANN", "MARTIAL", "DEPAY", "VERRATTI", "KESSIE", "GOMEZ", "XAVI", "GULLIT", "KHUSANOV", "YASHIN", "BECKENBAUER", "ZICO", "BECKHAM", "CRUYFF", "TEVEZ", "PELE", "MARADONA", "KEANE", "GERARD", "KAKA", "GARRINCHA", "CHERKI", "BARCOLA", 'DEMBELE', "NANI"
  ]
};

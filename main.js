...
const localWords = {
  ...
  Animals: [
    "KANGAROO", "PENGUIN", "CROCODILE", "ELEPHANT", "CHEETAH", "BEAR", "BIRD", "DOG", "CAT", "MONKEY", "SNAKE", "HORSE", "WOLF", "FOX", "FROG", "LION", "TIGER", "ZEBRA", "GIRAFFE", "HIPPOPOTAMUS", "RHINOCEROS", "SQUIRREL", "OTTER", "DEER", "RABBIT", "SNAIL", "CRAB", "OCTOPUS", "DOLPHIN", "SHARK", "WHALE", "SEAL", "JELLYFISH", "STARFISH", "LOBSTER", "ANTELOPE", "BUFFALO", "CAMEL", "DONKEY", "FERRET", "GOAT", "HAMSTER", "IBEX", "JAGUAR", "KOALA", "LEMUR", "MOOSE", "NEWt", "ORANGUTAN", "PORCUPINE", "QUOKKA", "RACCOON", "SLOTH", "TAPIR", "URIAL", "VULTURE", "WOMBAT", "XERUS", "YAK", "ZORILLA", "ALPACA", "BISON", "CHAMELEON", "DINGO", "EMU", "FLAMINGO", "GOLDFISH", "HEDGEHOG", "IGUANA", "KIWI", "LLAMA", "MANATEE", "NARWHAL", "OPOSSUM", "PANDA", "QUAIL", "RAVEN", "SALAMANDER", "TURTLE"
  ],
  ...
  FootballPlayers: [
    "MESSI", "RONALDO", "NEYMAR", "MBAPPE", "HAALAND", "SALAH", "KROOS", "KANTE", "LEWANDOWSKI", "SERGIO", "MODRIC", "SANE", "FODEN", "GREALISH", "RASHFORD", "SANCHO", "KANE", "BENZEMA", "LUKAKU", "STERLING", "SON", "MULLER", "ALISSON", "SUAREZ", "EDERSON", "COURTOIS", "OBLAK", "ONANA", "ARNOLD", "NAVAAS", "KARNEZIS", "PICKFORD", "GUENDOUZI", "MENDY", "TIERNEY", "SANCHEZ", "COUTINHO", "BALE", "RONALDINHO", "ROBBEN", "ZIDANE", "CANNAVARO", "PEREZ", "GERRARD", "SCHWEINSTEIGER", "INIESTA", "PIRLO", "GRIEZMANN", "MARTIAL", "DEPAY", "VERRATTI", "KESSIE", "XAVI", "GULLIT", "KHUSANOV", "YASHIN", "BECKENBAUER", "ZICO", "BECKHAM", "CRUYFF", "TEVEZ", "PELE", "MARADONA", "KEANE", "GERARD", "KAKA", "GARRINCHA", "CHERKI", "BARCOLA", 'DEMBELE', "NANI"
  ]
};
